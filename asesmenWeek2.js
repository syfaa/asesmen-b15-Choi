...
newVariabel = gelobal.map(function (huruf) {
  let newObject = {};
  newObject["asli"] = huruf;
  newObject["hurufPertama"] = huruf.charAt(0);
  return newObject;
});

console.log(newVariabel);
...
if (keranAir === "kanan") {
  console.log("Untuk air panas");
} else if (keranAir === "tengah") {
  console.log("Untuk air dingin.");
} else {
  console.log("Untuk mematikan air.");
}
